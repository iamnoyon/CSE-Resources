...
<body>
    ...
    <div class="container">
        <a href="{{url('/')}}" class="btn btn-primary my-3">Show Employee</a>
        ...
        <form action="{{url('/store-data')}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('job_title')}}" class="form-control" name="job_title" id="job_title">
            </div>
            <div class="mb-3">
                <label for="joining_date" class="form-label">Joining Date</label>
                <input type="date" value="{{old('joining_date')}}" class="form-control" name="joining_date" id="joining_date">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" value="{{old('mobile_no')}}" class="form-control" name="mobile_no" id="mobile_no">
            </div>
            <div class="mb-3">
